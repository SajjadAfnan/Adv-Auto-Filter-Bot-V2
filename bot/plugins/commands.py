...
async def start(bot, update):
    ...
    buttons = [[
        InlineKeyboardButton('Developers', url='https://t.me/mallu_movies_group2'),
        InlineKeyboardButton('Source Code 🧾', url ='https://t.me/mallu_movies_group2')
    ],[
        InlineKeyboardButton('Support 🛠', url='https://t.me/mallu_movies_group2')
    ],[
